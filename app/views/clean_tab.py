...
class CleanTab(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.drop_columns_list = QListWidget()
        self.drop_columns_list.setSelectionMode(QAbstractItemView.MultiSelection)
        self.drop_column_btn = QPushButton("Delete Selected Columns")
        self.zero_fill_columns_list = QListWidget()
        self.zero_fill_columns_list.setSelectionMode(QAbstractItemView.MultiSelection)
        self.zero_fill_bad_values_btn = QPushButton("Set Null/NA/Empty To 0")
    ...
    def _build_basic_tab(self) -> QWidget:
        page = QWidget()
        layout = QVBoxLayout(page)
        layout.addWidget(QLabel("Columns To Delete"))
        layout.addWidget(self.drop_columns_list)
        layout.addWidget(self.drop_column_btn)
        layout.addWidget(QLabel("Columns To Zero-Fill Bad Values"))
        layout.addWidget(self.zero_fill_columns_list)
        layout.addWidget(self.zero_fill_bad_values_btn)
